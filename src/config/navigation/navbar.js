...
const NavBar = () => {
	...
	return (
		...
		{!raw_data?.loading &&(
			<>
			<nav className='bg-gray-800 text-gray-800 p-1 ps-5'>Email: voiceforchange@ruangmei.com</nav>
			<header className="w-full text-center mb-5 ">
				...
				<nav className="flex border-b border-t border-gray-300 justify-center space-x-8 py-0 text-lg font-bold text-gray-700">
